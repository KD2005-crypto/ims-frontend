...
function ManageProjects() {
  ...
  const fetchProjects = async () => {
    const res = await fetch("https://ims-backend-production-5193.up.railway.app/api/projects");
    setProjects(await res.json());
  };

  const fetchMembers = async () => {
    const res = await fetch("https://ims-backend-production-5193.up.railway.app/api/members");
  ...
  const handleSubmit = async () => {
    ...
    const url = editingId
      ? `https://ims-backend-production-5193.up.railway.app/api/projects/${editingId}`
      : "https://ims-backend-production-5193.up.railway.app/api/projects";
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Delete this project?")) {
      await fetch(`https://ims-backend-production-5193.up.railway.app/api/projects/${id}`, { method: "DELETE" });
      fetchProjects();
    }
  };
